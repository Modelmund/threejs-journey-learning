...
import { html } from "./fs&resizing.md"
...
const mesh = new THREE.Mesh(
  ...
  new THREE.MeshBasicMaterial({ color: "yellowgreen", wireframe: false })
);
scene.add(mesh);
...
// 当controls.enabled为false时，在某些浏览器上会出现canvas仍然可以滚动的情况，这时会出现浏览器页面的空白背景
// 解决方案： html,body: { overflow: hidden }
